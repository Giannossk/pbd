...
public:
	...
	*/
	static bool solve_BallJoint(
		...
		const Quaternionr &q1,					// rotation of body 1
		const Matrix<Real,3,4, DontAlign> &ballJointInfo,	// precomputed ball joint info
	...
	*/
	static bool solve_BallOnLineJoint(
		...
		const Matrix3r &inertiaInverseW1,		// inverse inertia tensor (world space) of body 1
		const Quaternionr &q1,					// rotation of body 1
		const Matrix<Real, 3, 10, DontAlign> &jointInfo,	// precomputed joint info
		Vector3r &corr_x0, Quaternionr &corr_q0,
		Vector3r &corr_x1, Quaternionr &corr_q1);
	...
	*/
	static bool init_HingeJoint(
		...
		Matrix<Real, 4, 7, DontAlign> &hingeJointInfo
		);
	...
	*/
	static bool solve_HingeJoint(
		...
		const Matrix3r &inertiaInverseW1,		// inverse inertia tensor (world space) of body 1
		const Quaternionr &q1,					// rotation of body 1
		const Matrix<Real, 4, 7, DontAlign> &hingeJointInfo,	// precomputed hinge joint info
		Vector3r &corr_x0, Quaternionr &corr_q0,
		Vector3r &corr_x1, Quaternionr &corr_q1);
	...
	*/
	static bool solve_UniversalJoint(
		...
		const Matrix3r &inertiaInverseW1,		// inverse inertia tensor (world space) of body 1
		const Quaternionr &q1,					// rotation of body 1
		const Matrix<Real, 3, 8, DontAlign> &jointInfo,	// precomputed universal joint info
		Vector3r &corr_x0, Quaternionr &corr_q0,
		Vector3r &corr_x1, Quaternionr &corr_q1);
	...
	*/
	static bool solve_SliderJoint(
		...
		const Matrix3r &inertiaInverseW1,		// inverse inertia tensor (world space) of body 1
		const Quaternionr &q1,					// rotation of body 1
		const Matrix<Real, 4, 6, DontAlign> &jointInfo,	// precomputed slider joint info
		Vector3r &corr_x0, Quaternionr &corr_q0,
		Vector3r &corr_x1, Quaternionr &corr_q1);
	...
	*/
	static bool velocitySolve_TargetVelocityMotorSliderJoint(
		...
		const Matrix<Real, 4, 6, DontAlign> &jointInfo,	// precomputed joint info
	...
	*/
	static bool solve_TargetAngleMotorHingeJoint(
		...
		const Matrix<Real, 4, 8, DontAlign> &jointInfo,	// precomputed hinge joint info
		Vector3r &corr_x0, Quaternionr &corr_q0,
		Vector3r &corr_x1, Quaternionr &corr_q1);
	...
	*/
	static bool velocitySolve_TargetVelocityMotorHingeJoint(
		...
		const Matrix<Real, 4, 8, DontAlign> &jointInfo,	// precomputed joint info
		Vector3r &corr_v0, Vector3r &corr_omega0,
		Vector3r &corr_v1, Vector3r &corr_omega1);
	...
	*/
	static bool solve_RigidBodyParticleBallJoint(
		...
		const Matrix<Real, 3, 2, DontAlign> &jointInfo,	// precomputed joint info
		Vector3r &corr_x0, Quaternionr &corr_q0,
		Vector3r &corr_x1);
	...
	*/
	static bool solve_DistanceJoint(
		...
		const Real dt,
		const Matrix<Real,3,4, DontAlign> &jointInfo,	// precomputed joint info
		Real &lambda,
		Vector3r &corr_x0, Quaternionr &corr_q0,
		Vector3r &corr_x1, Quaternionr &corr_q1);
