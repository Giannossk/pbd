...
void integration::semiImplicitEuler(
	const Real h, 
	const Real mass, 
	Vector3r &position,
	Vector3r &velocity,
...
void integration::semiImplicitEulerRotation(
	const Real h,
	const Real mass,
...
void integration::velocityUpdateFirstOrder(
	const Real h,
	const Real mass,
...
void integration::angularVelocityUpdateFirstOrder(
	const Real h,
	const Real mass,
...
void integration::velocityUpdateSecondOrder(
	const Real h,
	const Real mass,
	const Vector3r &position,
	const Vector3r &oldPosition,
...
void integration::angularVelocityUpdateSecondOrder(
	const Real h,
	const Real mass,
	const Quaternionr &rotation,				
	const Quaternionr &oldRotation,			
